...
namespace Raid.Core
{
    public class Quest_I:Quest
    {
        public Quest_I()
        {
            ...
            base.Quest_Select_Position = new Vector2(1606, 207);
            base.Quest_Select_Box = new Rectangle((int)base.Quest_Select_Position.X,(int)base.Quest_Select_Position.Y, 96, 192);
