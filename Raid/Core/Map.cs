...
namespace Raid.Core
{
    public class Map
    {
        ...
        private Texture2D[] Area_Texture = new Texture2D[5];
        private Texture2D[] Area_Shadow = new Texture2D[5];
        private Vector2[] Area_Pos = new Vector2[5];
        private Rectangle[] Area_Box = new Rectangle[5];
        ...
        private void Load()
        {
            ...
            Area_Box[1] = new Rectangle((int)Area_Pos[0].X, (int)Area_Pos[0].Y, 1344, 1920);
            ...
            Area_Box[2] = new Rectangle((int)Area_Pos[0].X, (int)Area_Pos[0].Y, 2304, 1408);
            ...
            Area_Box[3] = new Rectangle((int)Area_Pos[0].X, (int)Area_Pos[0].Y, 1664, 1408);
            ...
            Area_Box[4] = new Rectangle((int)Area_Pos[0].X, (int)Area_Pos[0].Y, 1728, 3392);
